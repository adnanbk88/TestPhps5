             ...
             <div class="tabs product-tabs">
               ...
               <ul class="nav nav-tabs">                                
                 <li style="margin-top: 22px;" class="active">
                   <a href="#featured" data-toggle="tab">VENDEZ VOTRE TELEPHONE </a>
                 </li>                                
...
<div class="container">   
  <div class="containerr">
    ...
    <div class="content">
      <form action="{{url('/VenteForm')}}" method="POST" enctype="multipart/form-data">
        @csrf        
...
<option value="CASSE">CASSE</option>
        ...
        <div class="gender-details">
          <input type="radio" name="lu" id="dot-1">
     
          <span class="gender-title">Conditions</span>
          <label for="">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quam, repellendus neque. Similique sint laborum reprehenderit facere provident numquam ducimus! Aliquid, excepturi deleniti corporis nobis nisi cum at sit ratione quibusdam?</label>
          <div class="category">
            <label for="dot-1">
            <span class="dot one"></span>
            <span class="gender">J'ai lu et j'accepte les conditions</span>
          </label>
